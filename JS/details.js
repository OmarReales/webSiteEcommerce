...
async function renderDetails() {
  ...
  proDetails.innerHTML = `
        <div class="single-pro-image">
            ...
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="${getImagePath(
                      productLocal.sImg.img1
                    )}" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="${getImagePath(
                      productLocal.sImg.img2
                    )}" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="${getImagePath(
                      productLocal.sImg.img3
                    )}" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="${getImagePath(
                      productLocal.sImg.img4
                    )}" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        <div class="single-pro-details">
            ...
            <input class="quantity" id="quantity" type="number" min="1" data-id="${
              productLocal.id
            }" value="1">
            <button class="normal addcart" id="${
              productLocal.id
...
function renderBadge() {
  ...
  let totalQuantity = shoppingCart.reduce(
